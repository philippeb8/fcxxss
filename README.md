...
- Running: "export USERNAME=<username>"
...
It'll work until it reaches the quota of 1 GB generated by the server (please let me know if you need more). Also it was tested with GNU GCC 5 & 6, Clang 4 & 5.
